...
parser.add_argument('--root_path', type=str,
                    default=r"D:\BaiduNetdiskDownload\ACDC\ACDC", help='Name of Experiment')
parser.add_argument('--exp', type=str,
                    default='train_ACDC, help='experiment_name')
...
parser.add_argument('--cfg', type=str,
                    default=r"E:\newabd\code\configs\swin_tiny_patch4_window7_224_lite.yaml",
...
def Inference_model1(FLAGS):
    ...
    # snapshot_path = r"/ABD-main/code/ABD-main/model/BCP/o/ACDCtrain_BCP_3_labeled\self_train"
    test_save_path = r"D:\BaiduNetdiskDownload\ACDC_originbcp_7_labeled\self_train\\"
...
def Inference_model2(FLAGS):
    ...
    with open(FLAGS.root_path + '/test.list', 'r') as f:image_list = f.readlines()
    image_list = sorted([item.replace('\n', '').split(".")[0]for item in image_list])
    snapshot_path = r"D:\lyytest\ABD-main\ABD-main\code\ABD-main\model\\Cross_Teachingcetrue30000_kd\ACDC_train_ACDC_Cross_Teaching_7_labeled"
    test_save_path = r"D:\lyytest\ABD-main\ABD-main\code\ABD-main\model\\Cross_Teachingcetrue30000_kd\ACDC_train_ACDC_Cross_Teaching_7_labeled/ACDC_{}_{}/{}_predictions_model/".format(
